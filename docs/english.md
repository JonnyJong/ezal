...
## Procedural generate
This API can be used to create special pages like "home", "archive" or search index files like `search.json`, which can be generated by yourself, but it is recommended.
```js
